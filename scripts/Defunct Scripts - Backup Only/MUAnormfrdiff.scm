...
(define (script-fu-mua-normfrdiff Image Drawable)
...
(script-fu-register "script-fu-mua-normfrdiff"
    "MUA Normal Map Conversion from Diffuse"
    "Convert a diffuse map to Marvel Ultimate Alliance 2006's normal map (DXT5nm). Adds it on a new layer. Keeps a copy of the normal map (blueish) and a suggested specular map."
    "ak2yny"
    "ak2yny"
    "May 2020"
    "RGB*"
...
(script-fu-menu-register "script-fu-mua-normfrdiff" "<Image>/Script-Fu")